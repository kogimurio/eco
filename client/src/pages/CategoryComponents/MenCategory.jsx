...
const MenCategory = () => {
    ...
    useEffect(() => {
        const fetchMenCategory = async () => {
            ...
            try {
            const res = await axios.get(`${BASE_URL}/products?category=mens-fashion`)
    ...
    return (
        <div className="bg-gray-800 py-4 overflow-x-hidden">
            <div className="flex justify-between items-center w-[90%] mx-auto my-4">
                <h2 className="text-white text-sectionHeading font-semibold whitespace-nowrap">{category?.name}</h2>
            </div>
